...
const styles = {
    ...
    activeFilter: { background: 'lightblue', fontWeight: 'bold' }, // Estilo para filtro activo
    addButton: { fontSize: '24px', cursor: 'pointer', border: 'none', background: 'none', padding: '0 10px' },
    grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '20px' }, // Ajuste minmax
    ...
    productImage: { width: '100%', height: '140px', background: '#eee', borderRadius: '4px', overflow: 'hidden' }, // Ajuste altura
    ...
    productInfo: { marginTop: '10px', flexGrow: 1, display: 'flex', flexDirection: 'column' }, // Para empujar acciones abajo
    productDetails: { marginBottom: '10px' }, // Espacio entre detalles y acciones
    ...
    productActions: { display: 'flex', justifyContent: 'space-around', alignItems: 'center', borderTop: '1px solid #eee', paddingTop: '10px', marginTop: 'auto' }, // Alinear botones
    actionButton: { cursor: 'pointer', fontSize: '20px', background: 'none', border: 'none', padding: '5px' } // Aumentar tamaño icono
};
...
function ProductsAdmin() {
    ...
    if (loading) return <p style={styles.container}>Cargando productos...</p>;
