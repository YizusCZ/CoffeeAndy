        ...
        <div style={modalStyles.overlay} onClick={onClose}>
            <div style={modalStyles.modal} onClick={(e) => e.stopPropagation()}>
                ...
                <div style={modalStyles.formRow}>
                    <label style={modalStyles.label} htmlFor="cantidadModal">Cantidad:</label>
                    <input
                        id="cantidadModal"
                        style={{...modalStyles.input, flex: '0 1 80px'}}
                        type="number"
                        min="1"
                        value={cantidad}
                ...
                <div style={modalStyles.formRow}>
                    <label style={modalStyles.label} htmlFor="notaModal">Nota:</label>
                    <input
                        id="notaModal"
                        style={modalStyles.input}
                        type="text"
                        placeholder="Ej. Sin cebolla (opcional)"
                        value={nota}
